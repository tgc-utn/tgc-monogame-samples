...
### Known issues
- After install MGFXC - Tools directory '/Users/user/.dotnet/tools' is not currently on the PATH environment variable. - Some systems may require you to restart your terminal or IDE to recognize the new tool
