...
public class BoxPrimitive
{
    ...
    private void CreateVertexBuffer(GraphicsDevice graphicsDevice, Vector3 size)
    {
        ...
        {
            vertices[index] =
                new VertexPositionNormalTexture(positions[index], normals[index], textureCoordinates[index]);
        }

        _vertices = new VertexBuffer(graphicsDevice, VertexPositionNormalTexture.VertexDeclaration, vertices.Length,
            BufferUsage.None);
    ...
    private void CreateIndexBuffer(GraphicsDevice graphicsDevice)
    {
        ...
        _indices = new IndexBuffer(graphicsDevice, IndexElementSize.SixteenBits, indices.Length, BufferUsage.None);
