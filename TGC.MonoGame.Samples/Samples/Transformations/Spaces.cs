...
namespace TGC.MonoGame.Samples.Samples.Transformations
{
    ...
    public class Spaces : TGCSample
    {
        ...
        /// </summary>
        private float Interpolator { get; set; }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            switch (Space)
            {
                ...
                case SpaceType.World:
                    ...
                    Game.Gizmos.DrawFrustum(ViewerCamera.View * ViewerCamera.Projection,
                        Color.Yellow * (1f - Interpolator));
                    Game.Gizmos.DrawFrustum(ViewerCamera.Projection, Color.Green * Interpolator);
                    break;

                case SpaceType.View:
                    interpolated = Matrix.Lerp(BoxWorld * ViewerCamera.View,
                        BoxWorld * ViewerCamera.View * ViewerCamera.Projection, Interpolator);
