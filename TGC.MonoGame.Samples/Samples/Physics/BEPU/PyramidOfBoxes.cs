...
public class PyramidOfBoxes : TGCSample
{
    ...
    public PyramidOfBoxes(TGCViewer game)
        : base(game)
    {
    ...
    protected override void LoadContent()
    {
        ...
        for (var pyramidIndex = 0; pyramidIndex < pyramidCount; ++pyramidIndex)
        {
            ...
            for (var rowIndex = 0; rowIndex < rowCount; ++rowIndex)
            {
                ...
                {
                    var bh = _simulation.Bodies.Add(BodyDescription.CreateDynamic(
                        new NumericVector3(
        ...
        _simulation.Statics.Add(new StaticDescription(
            ...
            _simulation.Shapes.Add(new Box(2500, 1, 2500))));
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        Game.SpriteBatch.DrawString(_spriteFont, "Box handled: " + count + ".",
            new Vector2(GraphicsDevice.Viewport.Width - 500, 0), Color.White);
        Game.SpriteBatch.DrawString(_spriteFont, "Launch spheres with the 'Z' key.",
            new Vector2(GraphicsDevice.Viewport.Width - 500, 25), Color.White);
