...
namespace TGC.MonoGame.Samples.Samples.Collisions
{
    ...
    public class CameraCollision : TGCSample
    {
        ...
        public override void Initialize()
        {
            ...
            _wallWorldMatrices[0] = Matrix.CreateScale(scale) * Matrix.CreateRotationX(MathHelper.PiOver2) * Matrix.CreateTranslation(-Vector3.UnitZ * 200f + Vector3.UnitY * 200f);
            _wallWorldMatrices[1] = Matrix.CreateScale(scale) * Matrix.CreateRotationX(-MathHelper.PiOver2) * Matrix.CreateTranslation(Vector3.UnitZ * 200f + Vector3.UnitY * 200f);
            _wallWorldMatrices[2] = Matrix.CreateScale(scale) * Matrix.CreateRotationZ(MathHelper.PiOver2) * Matrix.CreateTranslation(Vector3.UnitX * 200f + Vector3.UnitY * 200f);
            _wallWorldMatrices[3] = Matrix.CreateScale(scale) * Matrix.CreateRotationZ(-MathHelper.PiOver2) * Matrix.CreateTranslation(-Vector3.UnitX * 200f + Vector3.UnitY * 200f);
            _wallWorldMatrices[4] = Matrix.CreateScale(new Vector3(100f, 1f, 100f)) * Matrix.CreateRotationZ(MathHelper.PiOver2) * Matrix.CreateTranslation(Vector3.UnitZ * 100f + Vector3.UnitY * 100f);
            ...
            _wallBoxes[0] = new BoundingBox(new Vector3(-200f, 0f, -200f) - minVector, new Vector3(200f, 200f, -200f) + minVector);
            _wallBoxes[1] = new BoundingBox(new Vector3(-200f, 0f, 200f) - minVector, new Vector3(200f, 200f, 200f) + minVector);
            _wallBoxes[2] = new BoundingBox(new Vector3(200f, 0f, -200f) - minVector, new Vector3(200f, 200f, 200f) + minVector);
            _wallBoxes[3] = new BoundingBox(new Vector3(-200f, 0f, -200f) - minVector, new Vector3(-200f, 200f, 200f) + minVector);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int index = 0; index < _wallWorldMatrices.Length - 1; index++)
            {
            ...
            _tilingEffect.Parameters["WorldViewProjection"].SetValue(_wallWorldMatrices[_wallWorldMatrices.Length - 1] * viewProjection);
            _quad.Draw(_tilingEffect);
