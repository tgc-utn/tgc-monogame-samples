...
namespace TGC.MonoGame.Samples.Viewer.GUI.Modifiers
{
    ...
    public class FloatModifier : IModifier
    {
        ...
        public FloatModifier(string name, Action<float> baseOnChange)
            : this(name)
        {
        ...
        public FloatModifier(string name, Action<float> baseOnChange, float defaultValue, float min, float max)
            : this(
        ...
        public FloatModifier(string name, EffectParameter effectParameter)
            : this(name)
        {
